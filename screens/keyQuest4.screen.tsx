...
function KeyQuest4({navigation}: Props): React.JSX.Element {
        ...
        <View style={{alignItems: 'center', marginTop: 90}}>
          <View style={{display: 'flex', flexDirection: 'row'}}>
            ...
            <TouchableOpacity onPress={() => setCorrectAnswer(true)}>
              <Image
                style={styles.key}
                source={require('../assets/img/key_shadow5.png')}
              />
              {correctAnswer && (
                <Image
                  style={[styles.key, {position: 'absolute', left: 0}]}
                  source={require('../assets/img/key4.png')}
                />
              )}
            </TouchableOpacity>
          ...
          {correctAnswer && (
            <YelGradientBtn
              text="Continue"
              onClick={() => navigation.navigate('LockQuest2')}
            />
          )}
        </View>
      </SafeAreaView>
