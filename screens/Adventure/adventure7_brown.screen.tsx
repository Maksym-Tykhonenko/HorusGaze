...
function Adventure7_brown({navigation}: Props) {
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={{alignItems: 'center', marginTop: 80}}>
        <Animated.Image
          source={require('../../assets/img/draw2_brown.png')}
          style={{
            width: 180,
            height: 180,
            marginBottom: 230,
        ...
        <YelGradientBtn
          text="Start"
          onClick={() => navigation.navigate('Adventure8')}
        />
      </View>
    </SafeAreaView>
  );
...
export default Adventure7_brown;
