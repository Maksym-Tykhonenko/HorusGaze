...
function Adventure2({navigation}: Props) {
      ...
      <View style={{alignItems: 'center', marginTop: 80}}>
        ...
        <View
          ...
          <Text style={{color: '#F2F2F2', margin: 12}}>
            Choose which of the facts is true and which is false. This test will
            show your attentiveness and ability to think logically. Remember,
            only one of the facts is true, and the choice is yours!
          </Text>
        </View>

        <YelGradientBtn
          text="Start"
          onClick={() => navigation.navigate('Adventure3')}
        />
      </View>
    </SafeAreaView>
  );
