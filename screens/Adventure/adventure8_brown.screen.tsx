...
function Adventure8_brown({navigation}: Props) {
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={{alignItems: 'center', marginTop: 80}}>
        <Animated.Image
          source={require('../../assets/img/draw3_brown.png')}
          style={{
            width: 180,
            height: 180,
            marginBottom: 230,
        ...
        <YelGradientBtn
          text="Start"
          onClick={() => navigation.navigate('Adventure9')}
        />
      </View>
    </SafeAreaView>
  );
...
export default Adventure8_brown;
